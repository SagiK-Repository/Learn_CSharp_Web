...
namespace Procademy_ASPNETCOREMVC_MVC.Controllers
{
    public class FileController : Controller
    {
        ...
        {
            string path = Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "wwwroot", "Machine_Learning_Operations_MLOps_Overview_Definition_and_Architecture.pdf");
        ...
        {
            byte[] byteData = System.IO.File.ReadAllBytes(Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "wwwroot", "Machine_Learning_Operations_MLOps_Overview_Definition_and_Architecture.pdf"));
